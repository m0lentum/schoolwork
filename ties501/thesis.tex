...
but it is useful to list some concrete operations satisfying this definition.
Table (TODO) lists the analogous vector operation for each combination of
forms in three dimensions, and table (TODO) does the same in 2D.

TODO: when to mention the basis 2-forms?

TODOs:
\begin{itemize}
  \item visualize 1-forms and 2-forms (line segments and parallelograms), maybe 3-forms
  ...
  \item acoustics equations expressed with differential forms?
    or maybe that should go in section \ref{dec_model}
...
\section{Discretizing the model}\label{dec_model}
