...
% - acoustics equations in terms of differential forms?
...
This section continues to follow the example of \parencite{desbrun_discrete_2006}.

\subsection{Discrete forms as integrals}

Recalling that k-forms can be integrated over k-manifolds,
a natural way to map a continuous differential form to a discrete value on a simplex
...
\subsection{Interpolating forms}
